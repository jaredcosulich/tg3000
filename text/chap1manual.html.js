...
</li><li> $[D]$ Which encloses the larger area --- <span class='textsc'>poly(5, 5)</span> or <span class='textsc'>poly(6,6)</span>?</li><li> $[P]$ Find inputs to <span class='textsc'>inspi</span> that give a nonclosed figure. Can you give
